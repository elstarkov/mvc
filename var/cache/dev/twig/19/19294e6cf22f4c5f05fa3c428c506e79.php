...
class __TwigTemplate_8adfd75e60f4c84e0f5368a09d602c2a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "    <br>
    <h2>
        Välkommen till samlingssidan för biblioteket!
    </h2>
    <p>
        Klicka på någon av knapparna för att komma vidare.
    </p>
    <br>
        <form action=\"";
        // line 14
        ...
        echo "\">
            <p>
                <input type=\"submit\" value=\"Visa böcker\">
            </p>
        </form>
    <br>
...
{% block body %}
    ...
    <br>
        <form action=\"{{ path('book_create') }}\">
            <p>
                <input type=\"submit\" value=\"Lägg till bok\">
            </p>
        </form>
        <form action=\"{{ path('book_show_all') }}\">
            <p>
                <input type=\"submit\" value=\"Visa böcker\">
            </p>
        </form>
...
{% endblock %}
", "book/index.html.twig", "/home/elstarkov/dbwebb-kurser/mvc/me/report/templates/book/index.html.twig");
    }
}
