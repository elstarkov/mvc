...
class __TwigTemplate_cdbf968cd6571037b3f5e85bb29594b9 extends Template
{
    private $source;
    private $macros = [];
    ...
    <br>
    <h2>
        När du klickar på \"shuffle\" i menyn så blandas kortleken.
        Du kan också uppdatera sidan.
    </h2>
    <div class=\"card\">
        <p>";
        // line 13
        echo twig_escape_filter($this->env, (isset($context["newDeck"]) || array_key_exists("newDeck", $context) ? $context["newDeck"] : (function () { throw new RuntimeError('Variable "newDeck" does not exist.', 13, $this->source); })()), "html", null, true);
        echo "</p>
    </div>
";
...
{% endblock %}
", "card/shuffle.html.twig", "/home/elstarkov/dbwebb-kurser/mvc/me/report/templates/card/shuffle.html.twig");
    }
}
